  ...
  render() {
    return (
      <div>
        ...
        <cnt-flexy-view-saqhan-promo-skils-wrapper-1_01 payload={skills} ></cnt-flexy-view-saqhan-promo-skils-wrapper-1_01>
          <cnt-flexy-view-saqhan-promo-portfolio-wrapper-1_01 payload={portfolio}></cnt-flexy-view-saqhan-promo-portfolio-wrapper-1_01>
        <cnt-flexy-view-saqhan-promo-contact-form-wrapper-1_01 payload={contactForm} ></cnt-flexy-view-saqhan-promo-contact-form-wrapper-1_01>
