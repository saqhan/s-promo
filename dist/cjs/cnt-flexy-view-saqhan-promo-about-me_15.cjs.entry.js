...
const index = require('./index-6c80b6a3.js');
...
const CntFlexyViewSaqhanPromoAboutMe = class {
    ...
    render() {
        return (index.h("div", { class: "wow animation_duration animate__fadeInUp", id: "about-me" }, index.h("div", { class: "container " }, index.h("div", { class: "row" }, index.h("div", { class: "col-sm-12 wrapper-title-about" }, index.h("div", { class: "titleBlock  " }, this.payload.title), index.h("div", { class: "subtitleBlock text-center lsp" }, this.payload.subTitle))), index.h("div", { class: "row  about-blocks-wrapper" }, index.h("div", { class: "col-12 col-md-6 col-lg-4" }, index.h("div", { class: "subtitleBlock text-center lsp pb-3" }, this.payload.aboutMe.title), index.h("div", { class: "text-justify" }, this.payload.aboutMe.text)), index.h("div", { class: "col-12 col-md-6 col-lg-4" }, index.h("div", { class: "myPhoto text-center", style: { backgroundImage: `url(${this.payload.img})` } })), index.h("div", { class: "col-12 col-md-12 col-lg-4" }, index.h("div", { class: "aboutContactsubtitle pb-3 " }, index.h("b", { class: "title-center" }, this.payload.contacts.name), index.h("br", null), index.h("br", null), this.payload.contacts.text, index.h("br", null), index.h("br", null), index.h("br", null), index.h("i", { class: "fas fa-phone-alt" }), " ", index.h("span", null, this.payload.contacts.phone), index.h("br", null), index.h("i", { class: "far fa-envelope" }), " ", index.h("span", null, this.payload.contacts.email), index.h("br", null), " ", index.h("br", null), " ", this.getSocialLinks(this.payload.socilaLinks)))))));
    }
    getSocialLinks(array) {
        return array.map(item => {
            return index.h("a", { href: item.links, target: "_blank", class: "footer-social-link ", "data-wow-delay": "0.2s" }, index.h("i", { class: item.class }));
        });
    }
};
...
const CntFlexyViewSaqhanPromoAboutMeWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-about-me", { payload: this.payload }));
    }
};
...
const CntFlexyViewSaqhanPromoContactForm = class {
    ...
    render() {
        return (index.h("section", { class: "fdb-block contact wow animation_duration animate__fadeIn", id: "contacts", style: { backgroundImage: `url(${this.payload.backgroundImage})` } }, index.h("div", { class: "bg-gray" }, index.h("div", { class: "container" }, index.h("div", { class: "row-100" }), index.h("div", { class: "row text-left" }, index.h("div", { class: "col-8" }, index.h("h1", { class: "title-contacts" }, this.payload.title))), index.h("div", { class: "row-100" }))), index.h("div", { class: "container bg-r" }, index.h("div", { class: "row-100" }), index.h("div", { class: "row" }, index.h("div", { class: "col-12 col-md-6 col-lg-5" }, index.h("div", { class: "text-large footer-subtitle " }, this.payload.subTitle), index.h("p", { class: "h3 mt-4 mt-lg-5" }, index.h("strong", null, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D:")), index.h("p", null, index.h("a", { href: "tel:+79659540034" }, this.payload.number)), index.h("p", { class: "h3 mt-4 mt-lg-5" }, index.h("strong", null, "\u041F\u043E\u0447\u0442\u0430:")), index.h("p", null, index.h("a", { href: "mailto:saqhan1@mail.ru" }, this.payload.email))), index.h("div", { class: "col-12 col-md-6 ml-auto" }, index.h("h2", { class: "footer-subtitle title-call" }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443"), index.h("form", { id: "form", onSubmit: (e) => this.sendMessageHandler(e) }, index.h("div", { class: "row" }, index.h("div", { class: "col" }, index.h("input", { ref: (el) => (this.nameInput = el), onBlur: () => this.checkInput(this.nameInput), type: "text", id: "name", name: "name", class: "form-control", placeholder: "\u0412\u0430\u0448\u0435 \u0438\u043C\u044F *" })), index.h("div", { class: "col" }, index.h("input", { ref: (el) => (this.phoneInput = el), onBlur: () => this.checkInput(this.phoneInput), type: "tel", id: "phone", name: "phone", class: "form-control", placeholder: "\u0422\u0435\u043B\u0435\u0444\u043E\u043D *" }))), index.h("div", { class: "row mt-4" }, index.h("div", { class: "col" }, index.h("input", { id: "email", type: "text", name: "email", class: "form-control", placeholder: "E-mail" }))), index.h("div", { class: "row mt-4" }, index.h("div", { class: "col" }, index.h("select", { class: "form-control", name: "type" }, index.h("option", { value: "" }, "\u0421\u0430\u0439\u0442 \u043A\u0430\u043A\u043E\u0433\u043E \u0442\u0438\u043F\u0430 \u0412\u0430\u0441 \u0438\u043D\u0442\u0435\u0440\u0435\u0441\u0443\u0435\u0442?"), index.h("option", { value: "Landing" }, "\u041B\u0435\u043D\u0434\u0438\u043D\u0433"), index.h("option", { value: "Blog" }, "\u0421\u0430\u0439\u0442-\u0431\u043B\u043E\u0433"), index.h("option", { value: "Maket" }, "\u0418\u043D\u0442\u0435\u0440\u043D\u0435\u0442 \u043C\u0430\u0433\u0430\u0437\u0438\u043D")))), index.h("div", { class: "row mt-4" }, index.h("div", { class: "col" }, index.h("textarea", { class: "form-control", name: "message", placeholder: "\u0418\u043B\u0438 \u043D\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u0437\u0434\u0435\u0441\u044C \u0412\u0430\u0448 \u0442\u0435\u043A\u0441\u0442" }))), index.h("div", { class: "row mt-4" }, index.h("div", { class: "col" }, index.h("button", { type: "submit", class: "btn btn-send" }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C"), index.h("div", { id: "hide-block", ref: (el) => (this.hideBlock = el) }, "\u0421\u043F\u0430\u0441\u0438\u0431\u043E \u0437\u0430 \u0437\u0430\u044F\u0432\u043A\u0443!")))))))));
    }
    /*
     * send new mess
     * */
...
const CntFlexyViewSaqhanPromoContactFormWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-contact-form", { payload: this.payload }));
    }
};
...
const CntFlexyViewSaqhanPromoFooter = class {
    ...
    render() {
        return (index.h("div", null, index.h("footer", { class: "fdb-block footer-small pt-5", style: { backgroundImage: `url(${this.categories.footerBackgroundImage})` } }, index.h("div", { class: "container" }, index.h("div", { class: "row text-center align-items-center" }, index.h("div", { class: "col", id: "navbarBottom" }, index.h("ul", { class: "nav " }, this.getItemSticky(this.categories.stickyTop)), index.h("p", { class: "h6 footer-copyright" }, "\u00A9 2020 \u0420\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0430 \u0438 \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u0441\u0430\u0439\u0442\u043E\u0432 SAQHAN")))))));
    }
    /**
     * for items sticky
     * */
    getItemSticky(array) {
        return array.map((item) => {
            return (index.h("li", { class: "nav-item " }, index.h("a", { class: "nav-link", href: `#${item.id}` }, item.name), "\u203A"));
        });
    }
};
...
const CntFlexyViewSaqhanPromoFooterWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-footer", { categories: this.categories }));
    }
};
...
const CntFlexyViewSaqhanPromoHeader = class {
    ...
    render() {
        return (index.h("div", null, index.h("cnt-flexy-view-saqhan-promo-sticky-top", { navItems: this.categories.stickyTop, socialLinks: this.categories.socilaLinks }), index.h("div", { class: "container-fluid head", style: { backgroundImage: `url(${this.categories.backgroundImage})` } }, index.h("div", { class: "row flex-center" }, index.h("div", { class: "topContent wow animation_duration animate__fadeIn " }, index.h("div", { class: "logo", style: { backgroundImage: `url(${this.categories.logoMain})` } }), index.h("div", { class: "titleBlock " }, this.categories.headerTitle), index.h("button", { id: "myBtn", class: "button myBtn sendBtn", onClick: () => this.showModal(), ref: (el) => (this.sendBtn = el) }, index.h("span", null, this.categories.headerBtnTitle), " ")))), index.h("div", { class: "overlay openModal", id: "openModal", ref: (el) => (this.overlay = el) }, index.h("div", { class: "popup" }, index.h("div", { class: "popup-close", onClick: () => this.closeModal() }, "\u00D7"), index.h("div", { class: "popup-title" }, "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443!"), index.h("div", { class: "popup-form", style: { backgroundImage: `url(http://saqhan.ru/img/pre-stage/modal_bg.jpg)` } }, index.h("form", { id: "overlayForm", action: "#", class: "main-form" }, index.h("label", { class: "popup-form__label", htmlfor: "phone" }, "\u041E\u0441\u0442\u0430\u0432\u0442\u044C\u0435 \u0441\u0432\u043E\u0439 \u043D\u043E\u043C\u0435\u0440 \u0438 \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u0441\u0432\u044F\u0436\u0443\u0441\u044C \u0441 \u0412\u0430\u043C\u0438!"), index.h("input", { class: "popup-form__input", id: "phoneTop", name: "phone", type: "tel", placeholder: "+7(965) 954-00-34" }), index.h("button", { class: "button popup-form__btn" }, "\u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443!"), index.h("div", { id: "hide-blockTop" }, "\u0421\u043F\u0430\u0441\u0438\u0431\u043E \u0437\u0430 \u0437\u0430\u044F\u0432\u043A\u0443! \u041C\u044B \u0441\u043A\u043E\u0440\u043E \u0441\u0432\u044F\u0436\u0435\u043C\u0441\u044F \u0441 \u0412\u0430\u043C\u0438!")))))));
    }
    /*
     * showModal
     * **/
...
const CntFlexyViewSaqhanPromoHeaderWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-header", { categories: this.categories }));
    }
};
...
const CntFlexyViewSaqhanPromoPortfolio = class {
    ...
    render() {
        return (index.h("div", { class: "portfolio-wrapper wow animation_duration animate__fadeInUp", id: 'portfolio' }, index.h("div", { class: "container" }, index.h("div", { class: "title " }, "\u041F\u043E\u0440\u0442\u0444\u043E\u043B\u0438\u043E"), index.h("div", { class: "categories " }, index.h("ul", null, this.getCategories(this.payload.categoriesPortfolio))), index.h("div", { class: "cars-wrapper   row" }, this.getCard(this.portfolioCardState)))));
    }
    /**
     * get a card
     * */
    getCard(array) {
        return array.map((item) => {
            return (index.h("div", { class: "col-12 col-md-6 col-lg-4" }, index.h("div", { class: "card-portfolio  wow animation_duration animate__fadeIn " }, index.h("div", { class: "img", style: { backgroundImage: `url(${item.img})` } }), index.h("div", { class: "details" }, index.h("div", { class: "description" }, item.title), index.h("div", { class: "btns" }, index.h("a", { target: "_blank", href: item.linkApp, class: "check-app" }, "\u041F\u0435\u0440\u0435\u0439\u0442\u0438 ", index.h("i", { class: "fas fa-external-link-alt" })), item.linkGithub.length ? (index.h("a", { target: "_blank", href: item.linkGithub, class: "check-in-github" }, "Github ", index.h("i", { class: "fab fa-github" }))) : (""))))));
        });
    }
    /**
     * get category
    ...
    getCategories(array) {
        return array.map((item) => {
            return (index.h("li", { class: { active: item.id === this.lastClickedCategory }, onClick: () => this.filterCategoryPortfolioHandler(item.id) }, item.name));
        });
    }
...
const CntFlexyViewSaqhanPromoPortfolioWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-portfolio", { payload: this.payload }));
    }
};
...
const CntFlexyViewSaqhanPromoSkils = class {
    ...
    render() {
        return (index.h("div", { class: "wow animation_duration animate__fadeInUp", id: "skills" }, index.h("div", { class: "container" }, index.h("div", { class: "row" }, index.h("div", { class: "col-12" }, index.h("div", { class: "title" }, "\u041D\u0430\u0432\u044B\u043A\u0438"))), index.h("div", { class: "row wrapper-cards" }, index.h(SkillsCard, { skills: this.payload })))));
    }
};
const SkillsCard = (props) => {
    return props.skills.map((item) => {
        return (index.h("div", { class: "col-md-6" }, index.h("cnt-flexy-view-saqhan-promo-skils-card", { skills: item })));
    });
};
...
const CntFlexyViewSaqhanPromoSkilsCard = class {
    ...
    render() {
        return (index.h("div", { class: "card-skills" }, index.h("div", { class: "state-wrapper" }, index.h("div", { class: "name" }, this.skills.name), index.h("div", { class: "number" }, this.skills.percent, "%")), index.h("div", { class: "progress" }, index.h("div", { class: "wow progress-bar", style: { width: `${this.skills.percent}%` } }))));
    }
};
...
const CntFlexyViewSaqhanPromoSkilsWrapper = class {
    ...
    render() {
        return (index.h("cnt-flexy-view-saqhan-promo-skils", { payload: this.payload }));
    }
};
...
const CntFlexyViewSaqhanPromoStickyTop = class {
    ...
    render() {
        return (index.h("div", null, index.h("div", { class: "menu", ref: (el) => (this.menuTag = el) }, index.h("div", { class: "container-fluid bg-dark" }, index.h("div", { class: "container  " }, index.h("div", { class: "row" }, index.h("div", { class: "menu-main" }, index.h("div", { class: "menu-desktop" }, index.h("ul", null, this.getItemSticky(this.navItems))), index.h("div", { class: " soc-links " }, index.h("ul", { class: "nav mom-social-icons" }, this.getItemLinks(this.socialLinks))))))), index.h("div", { class: "menu-wrapper col-md-12 d-lg-none" }, !this.isShowBar ?
            index.h("button", { type: "button", class: "menu-mobile-button", onClick: () => this.showMobileMenuHandler() }, index.h("span", null, index.h("i", { class: "fa fa-bars" }))) : '')), index.h("div", { class: "mobile-menu d-lg-none", ref: (el) => (this.mobileMenuTag = el) }, index.h("div", { class: "container" }, index.h("div", { class: "mobile-menu-close", onClick: () => this.showMobileMenuHandler() }, index.h("span", null, index.h("i", { class: "fas fa-times" }))), index.h("nav", { class: "mobile-menu-wrapper" }, index.h("ul", null, this.getItemSticky(this.navItems)))))));
    }
    /**
     * for items sticky
     * */
    getItemSticky(array) {
        return array.map((item) => {
            return (index.h("li", { class: "nav-item " }, index.h("a", { class: "nav-link anchor", href: `#${item.id}` }, item.name)));
        });
    }
    /**
     * for items sticky
    ...
    getItemLinks(array) {
        return array.map((item) => {
            return (index.h("li", { class: item.name }, index.h("a", { target: "_blank", rel: "fa-icon-vk", href: item.links }, index.h("i", { class: item.class }))));
        });
    }
    /**
...
const MyComponent = class {
    ...
    render() {
        return (index.h("div", null, index.h("cnt-flexy-view-saqhan-promo-header-wrapper-1_01", { categories: header }), index.h("cnt-flexy-view-saqhan-promo-about-me-wrapper-1_01", { payload: aboutMe }), index.h("cnt-flexy-view-saqhan-promo-skils-wrapper-1_01", { payload: skills }), index.h("cnt-flexy-view-saqhan-promo-portfolio-wrapper-1_01", { payload: portfolio }), index.h("cnt-flexy-view-saqhan-promo-contact-form-wrapper-1_01", { payload: contactForm }), index.h("cnt-flexy-view-saqhan-promo-footer-wrapper", { categories: header })));
    }
};
MyComponent.style = myComponentCss;

exports.cnt_flexy_view_saqhan_promo_about_me = CntFlexyViewSaqhanPromoAboutMe;
exports.cnt_flexy_view_saqhan_promo_about_me_wrapper_1_01 = CntFlexyViewSaqhanPromoAboutMeWrapper;
exports.cnt_flexy_view_saqhan_promo_contact_form = CntFlexyViewSaqhanPromoContactForm;
exports.cnt_flexy_view_saqhan_promo_contact_form_wrapper_1_01 = CntFlexyViewSaqhanPromoContactFormWrapper;
exports.cnt_flexy_view_saqhan_promo_footer = CntFlexyViewSaqhanPromoFooter;
exports.cnt_flexy_view_saqhan_promo_footer_wrapper = CntFlexyViewSaqhanPromoFooterWrapper;
exports.cnt_flexy_view_saqhan_promo_header = CntFlexyViewSaqhanPromoHeader;
exports.cnt_flexy_view_saqhan_promo_header_wrapper_1_01 = CntFlexyViewSaqhanPromoHeaderWrapper;
exports.cnt_flexy_view_saqhan_promo_portfolio = CntFlexyViewSaqhanPromoPortfolio;
exports.cnt_flexy_view_saqhan_promo_portfolio_wrapper_1_01 = CntFlexyViewSaqhanPromoPortfolioWrapper;
exports.cnt_flexy_view_saqhan_promo_skils = CntFlexyViewSaqhanPromoSkils;
exports.cnt_flexy_view_saqhan_promo_skils_card = CntFlexyViewSaqhanPromoSkilsCard;
exports.cnt_flexy_view_saqhan_promo_skils_wrapper_1_01 = CntFlexyViewSaqhanPromoSkilsWrapper;
exports.cnt_flexy_view_saqhan_promo_sticky_top = CntFlexyViewSaqhanPromoStickyTop;
