...
const cntFlexyViewSaqhanPromoContactFormCss = ".contact.sc-cnt-flexy-view-saqhan-promo-contact-form{padding:50px 0px}.contact.sc-cnt-flexy-view-saqhan-promo-contact-form{background-image:url(http://saqhan.ru/img/9.svg);background-size:cover}.title-contacts.sc-cnt-flexy-view-saqhan-promo-contact-form{font-size:40px;margin-bottom:25px}.footer-subtitle.sc-cnt-flexy-view-saqhan-promo-contact-form{font-size:28px;font-weight:400}.title-call.sc-cnt-flexy-view-saqhan-promo-contact-form{margin-top:10px}.btn.sc-cnt-flexy-view-saqhan-promo-contact-form{width:140px;letter-spacing:1px;position:relative;font-size:20px}.btn-send.sc-cnt-flexy-view-saqhan-promo-contact-form{background-color:#fe6347;color:#fff}#hide-block.sc-cnt-flexy-view-saqhan-promo-contact-form{display:none;background-color:#4e8000;padding:10px;margin-top:20px;border-radius:3px;color:#fff;transition:0.6s ease}";
...
export { CntFlexyViewSaqhanPromoContactForm as cnt_flexy_view_saqhan_promo_contact_form };
