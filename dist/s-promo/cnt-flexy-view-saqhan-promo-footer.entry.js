...
const cntFlexyViewSaqhanPromoFooterCss = ".fdb-block.sc-cnt-flexy-view-saqhan-promo-footer{background:url(http://saqhan.ru/img/footer-bg.png)}.footer-copyright.sc-cnt-flexy-view-saqhan-promo-footer{color:#ffffff;margin-top:30px;margin-bottom:50px}.nav.sc-cnt-flexy-view-saqhan-promo-footer{justify-content:center}";
...
export { CntFlexyViewSaqhanPromoFooter as cnt_flexy_view_saqhan_promo_footer };
