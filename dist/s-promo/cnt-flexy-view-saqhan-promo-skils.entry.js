...
const cntFlexyViewSaqhanPromoSkilsCss = ".title.sc-cnt-flexy-view-saqhan-promo-skils{font-size:40px;text-align:center}.wrapper-cards.sc-cnt-flexy-view-saqhan-promo-skils{display:flex;justify-content:space-between;margin-bottom:60px}";
...
export { CntFlexyViewSaqhanPromoSkils as cnt_flexy_view_saqhan_promo_skils };
