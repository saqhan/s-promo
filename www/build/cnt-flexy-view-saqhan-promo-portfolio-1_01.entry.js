...
const CntFlexyViewSaqhanPromoPortfolio = class {
    ...
    render() {
        return (h("div", { class: "portfolio-wrapper" }, h("div", { class: "container" }, h("div", { class: "title" }, "\u041F\u043E\u0440\u0442\u0444\u043E\u043B\u0438\u043E"), h("div", { class: "categories" }, h("ul", null, this.getCategories(this.payload.categoriesPortfolio))), h("div", { class: "cars-wrapper row" }, this.getCard(this.portfolioCardState)))));
    }
    /**
     * get a card
     * */
    ...
    getCategories(array) {
        return array.map((item) => {
            return (h("li", { onClick: () => this.filterCategoryPortfolioHandler(item.id) }, item.name));
        });
    }
